...
//XXX move all dependencies in this app to either path inside quotes or outside.
...
class HTTP extends Server {
  ...
  constructor(options) {
    //Temporary Hack, fix this by putting ndb into HTTPOptions
  ...
  initRouter() {
    ...
    this.get("/nomenclate/address/:hash/history", async (req, res) => {
      ...
      let txs = await this.ndb.getAddressHashHistory(hash);

      let result = common.sortTXs(txs);
